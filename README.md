...
Ниже встроено видео-демо, которое находится в репозитории (video/video.mp4). Если ваш браузер и GitHub позволяют воспроизведение — плеер покажется прямо в README.

<!-- Встроенный плеер -->
<video src="https://raw.githubusercontent.com/Lesaght/TXT-CLI/146a3b7e8a9e4d52bfd7b9c71942f83da32e53b2/video/video.mp4" controls preload="metadata" style="max-width:100%; height:auto; border-radius:8px; box-shadow:0 6px 18px rgba(0,0,0,0.15);">
  Ваш браузер не поддерживает тег video. Откройте видео по ссылке: https://github.com/Lesaght/TXT-CLI/blob/146a3b7e8a9e4d52bfd7b9c71942f83da32e53b2/video/video.mp4
</video>

> Примечание: GitHub иногда блокирует прямое воспроизведение больших видео из raw-сервера. Если видео не воспроизводится, используйте одну из ссылок ниже:

- Просмотреть/скачать (GitHub): https://github.com/Lesaght/TXT-CLI/blob/146a3b7e8a9e4d52bfd7b9c71942f83da32e53b2/video/video.mp4
- Прямая (raw) ссылка: https://raw.githubusercontent.com/Lesaght/TXT-CLI/146a3b7e8a9e4d52bfd7b9c71942f83da32e53b2/video/video.mp4
...
**TXT-CLI** — это универсальный инструмент командной строки для быстрой и удобной обработки текстовых файлов. Он создан с упором на производительность, простоту и гибкость.
...
- ✅ **Гибкие опции** - настраиваемые параметры под ва��и нужды
